...
public interface VersionWrapper {
     ...
     */
    void openSignEditor(Player player, String[] lines, Object[] adventureLines, Material type, DyeColor color, boolean glow, Location signLoc, BiConsumer<SignEditor, String[]> onFinish, BiConsumer<Location, Runnable> locationScheduler) throws Exception;
